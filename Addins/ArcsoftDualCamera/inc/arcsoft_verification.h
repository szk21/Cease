...
#include "./platform/asvloffscreen.h"
#include "./platform/merror.h"
#include "./platform/amcomdef.h"
...
{
    UINT lCodebase;		/**< platform dependent       */
    UINT lMajor;			/**< major version            */ 
    UINT lMinor;			/**< minor version            */
    UINT lBuild;			/**< increasable only         */
    char* Version;			/**< version in string format */
    char* BuildDate;		/**< latest build Date        */
